...
import ch.heigvd.sft.BlobDetector;
...
public class VideoStageRenderer implements Renderer {
	...
	public VideoStageRenderer(ControlDroneActivity context, Bitmap initialTexture)
	{
		activity = context;
	...
	public void onDrawFrame(Canvas canvas)
	{
		...
		if (openCVReady) {
			// We have to wait for opencv to be ready to allocate our blob detector
			if (detector == null) {
				detector = new BlobDetector(activity);
				frame = new Mat();
			}
			Bitmap bitmap = bgSprite.getVideoBitmap();
